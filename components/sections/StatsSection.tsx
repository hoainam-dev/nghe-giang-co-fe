...
export default function StatsSection() {
  return (
    <section className="relative overflow-hidden bg-[#0b4ea2] py-12">
        ...
        <div className="relative grid gap-8 text-center text-white md:grid-cols-3">
          {[
            ...
            <div key={label} className="group">
              ...
              <div className="bg-brand-gold/50 mx-auto mt-3 h-px w-8 transition-all duration-300 group-hover:w-16" />
              <p className="text-brand-muted/85 mt-3 text-sm font-medium tracking-wide">{label}</p>
            </div>
          ))}
        </div>
      </Container>
