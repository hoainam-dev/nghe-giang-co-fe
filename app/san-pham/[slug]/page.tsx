                        ...
                        <div className="grid gap-8 xl:grid-cols-[0.90fr_1.10fr] xl:gap-10">
                            <Reveal variant="fade-right">
                                <div className={cn(
                                    ...
                                    !product.packageImage && "grid-cols-1 md:grid-cols-1 max-w-[600px] mx-auto"
                                )}>
                                    {product.packageImage && <div className="relative flex w-full h-auto items-center justify-center rounded-[1.5rem] xl:p-0 xl:shadow-none">
                                        <Image
                                            src={product.packageImage}
                                            alt={`Vỏ bao ${product.name}`}
                                            width={260}
                                            height={260}
                                            className="object-contain w-fit sm:w-full h-auto drop-shadow-xl"
                                        />
                                    </div>}
                                    <div className="grid grid-cols-1 gap-4">
                                        {product.frontImage && <div className="relative flex w-full h-auto items-center justify-center rounded-[1.5rem] xl:p-0 xl:shadow-none">
                                            <Image
                                        ...
                                        {product.backImage && <div className="relative flex w-full h-auto items-center justify-center rounded-[1.5rem] xl:p-0 xl:shadow-none">
                                            <Image
                                            ...
                                            <div className="border-b border-slate-200 bg-[#0b4ea2] p-4 text-white sm:p-6">
                                                <div className="flex items-start gap-3 sm:items-center">
                                                    ...
                                                    <div className="min-w-0">
                                                        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#d7a321] sm:text-sm sm:tracking-[0.18em]">
                                                            Tỷ lệ cấp phối
                                                        </p>
                                                        <h3 className="mt-1 text-lg font-black leading-snug sm:text-2xl">
                                            ...
                                            <div className="hidden sm:block">
                                                <div className="overflow-x-auto">
                                                    <table className="w-full min-w-[680px] border-collapse text-left">
                                                        <thead>
                                                            <tr className="bg-slate-50 text-sm uppercase text-[#0b2f66]">
                                                ...
                                                {product.usage.mixRatio.map((row) => (
                                                    <div key={row.material} className="p-4">
                                                        <div className="mb-3 flex items-center justify-between gap-3">
                                                            <p className="font-black text-[#0b2f66]">
                                                                {row.material}
                                                            </p>
