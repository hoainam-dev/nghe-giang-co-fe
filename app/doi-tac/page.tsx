...
export const metadata = {
    title: "Các đối tác",
    description:
        "Mạng lưới đối tác đồng hành cùng Nghệ Giang trong lĩnh vực phân phối xi măng.",
};
                    ...
                    <div className="max-w-4xl">
                        ...
                        <Reveal variant="fade-up" delay={200}>
                            <p className="mt-5 max-w-2xl text-sm leading-7 text-blue-50 sm:text-base lg:text-lg lg:leading-8">
                                Nghệ Giang xây dựng mạng lưới hợp tác bền vững với các nhà máy,
                                nhà thầu, đại lý và đơn vị logistics nhằm mang đến giải pháp
                                cung ứng xi măng ổn định, chuyên nghiệp.
                            </p>
                        </Reveal>
                            ...
                            {partnerStats.map((item, index) => (
                                <Reveal key={item.label} variant="zoom-in" delay={260 + index * 80}>
                                    <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur">
                                        <p className="text-3xl font-black text-[#d7a321]">
                                            {item.value}
                                        </p>
                        ...
                        {partners.map((partner, index) => (
                            <Reveal key={partner.name} variant="fade-up" delay={index * 70}>
                                <div className="group relative h-full overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[#d7a321]/60 hover:shadow-xl sm:p-6">
                                    <div className="absolute -right-10 -top-10 size-28 rounded-full bg-[#0b4ea2]/5 transition duration-300 group-hover:bg-[#d7a321]/15" />
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="mb-3 flex items-center gap-2">
                                            <BadgeCheck
                                                size={18}
                                                className="shrink-0 text-[#d7a321]"
                                            />
                                            <h3 className="text-lg font-black text-[#0b2f66]">
                                                {partner.name}
                                            </h3>
                                        </div>
                    ...
                    <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <Reveal variant="fade-right">
                            <div>
                                ...
                                <h2 className="mt-3 text-2xl font-black uppercase leading-tight text-[#0b2f66] sm:text-3xl lg:text-4xl">
                                    Hợp tác dựa trên uy tín, chất lượng và hiệu quả vận hành
                                </h2>
                                <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base sm:leading-8">
                                    Chúng tôi hướng đến xây dựng hệ sinh thái phân phối xi măng
                                    chuyên nghiệp, nơi mỗi đối tác đều đóng vai trò quan trọng
                                    trong việc đảm bảo chất lượng sản phẩm và tiến độ cung ứng.
                                </p>
                            </div>
                        </Reveal>
