      ...
      <Container className="relative">
        <div className="max-w-4xl">
          <Reveal variant="fade-down">
            <p className="text-xs font-bold tracking-[0.16em] text-[#d7a321] uppercase sm:text-sm sm:tracking-[0.2em]">
              {product.brand}
            </p>
          </Reveal>

          <Reveal variant="blur" delay={100}>
            <h1 className="mt-3 text-[30px] leading-[1.15] font-black sm:mt-4 sm:text-4xl md:text-5xl lg:text-6xl">
              {product.name}
            </h1>
          </Reveal>
