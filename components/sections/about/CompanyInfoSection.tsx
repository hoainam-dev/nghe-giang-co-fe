...
export default function CompanyInfoSection() {
    return (
        <section className="relative overflow-hidden bg-white py-14 md:py-20">
            ...
            <div className="absolute right-0 top-0 h-32 w-32 rounded-bl-full bg-[#0b4ea2]/10" />
            <div className="absolute bottom-0 left-0 h-24 w-24 rounded-tr-full bg-[#d7a321]/15" />

            <Container className="relative">
                <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
                    <Reveal variant="fade-right">
                        <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white/95 p-6 shadow-2xl backdrop-blur md:p-6 min-h-[560px]">
                            ...
                            <div className="relative">
                                ...
                                <h2 className="text-2xl font-black leading-tight text-[#0b2f66] md:text-2xl xl:text-4xl">
                                    {companyInfo.fullName}
                                </h2>

                                <p className="mt-4 text-sm font-semibold uppercase tracking-[0.12em] text-[#d7a321] md:text-base">
                                ...
                                <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-[#d7a321]">
                                                Người đại diện
                                            </p>
                ...
                <Reveal variant="fade-up" delay={120}>
                    <div className="mt-8 grid overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-xl md:grid-cols-3">
                        <a
                            ...
                            className="group h-full flex items-center gap-4 border-b border-slate-200 p-5 transition hover:bg-[#0b4ea2] md:border-b-0 md:border-r"
                        >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="mt-1 break-all font-black text-[#0b2f66] transition group-hover:text-white">
                                    {companyInfo.email}
                                </p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="mt-1 font-black leading-6 text-[#0b2f66] transition group-hover:text-white">
                                    {companyInfo.address}
                                </p>
                            </div>
                        </a>
